        ...
        success: function(data) {
            ...
            for (var i = 0; i < length; i++) {
                ...
                append += data.data[i].type == 'image' ? // image ?
                            ...
                            '<canvas width="100%" height="100%"></canvas><video height="99%" width="100%" src="'+data.data[i].videos.standard_resolution.url+'" controls="undefined" buffer="undefined"></video>'; // no
